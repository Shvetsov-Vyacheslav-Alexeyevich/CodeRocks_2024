<?
    class MysqlModel
    {
        ...
        // Складывает строки из базы данных в виде массивов в массив
        // [[1, 2, 3], [1, 2, 3], [1, 2, 3]]
        // Применимы только SELECT-запросы
        ...
        // Складывает ОДНУ ПЕРВУЮ строку из базы данных в массив
        // [1, 2, 3]
        // Применимы только SELECT-запросы
        ...
        // Функция для использования всех остальных запросов, кроме SELECT, а именно:
